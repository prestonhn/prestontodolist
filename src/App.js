...
const Footer = () => {
  return (
    <>
        <p className="love">
        Created by Preston Nguyen
        </p>
        <p className="socials"> 
          <a href="https://github.com/prestonhn" rel="noreferrer" target="_blank"><VscGithub size={25}/></a>
          <a href="https://www.linkedin.com/in/prestonhnguyen/" rel="noreferrer" target="_blank"><SiLinkedin size={25}/></a>
        </p>
        <p>
            <a href="https://github.com/prestonhn" rel="noreferrer" target="_blank" className="source">$Source | 2023 - 2024</a> 
        </p> 
